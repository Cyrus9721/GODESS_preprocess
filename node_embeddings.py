...
class create_node_embeddings:
    ...
    def __init__(self, data_dir='dataset/Godess_final_data/Godess_data/',
                 ...
                 out_bound_AB_embed='dataset/Godess_final_data/embedding/bound_ab.csv', out_DL_embed='dataset/Godess_final_data/embedding/bound_dl.csv',
