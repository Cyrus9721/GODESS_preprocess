...
class build_adjacency_matrix:
    def __init__(self, labeled_pdb_dir='dataset/Godess_final_data/Godess_data/',
                 out_adjacency_dir='dataset/Godess_final_data/graph/directory_graph_connection/',
                 out_interaction_dir='dataset/Godess_final_data/graph/directory_graph_interaction/', threshold_carbon=1.65,
